...
Partial Public Class CarsDBDataSet
    ...
    Partial Public Class CarsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddCarsRow(ByVal Trademark As String) As CarsRow
            Dim rowCarsRow As CarsRow = CType(Me.NewRow,CarsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Trademark}
...
Namespace CarsDBDataSetTableAdapters
    ...
    Partial Public Class CarsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`) VALUES (?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Trademark` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` I"& _ 
                "S NULL) OR (`Trademark` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Trademark FROM Cars"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Trademark As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Trademark As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Trademark As String, ByVal Original_ID As Integer, ByVal Original_Trademark As String) As Integer
            If (Trademark Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Original_Trademark,String)
            End If
